...
# ==========================================
# 3. API VE MODEL AYARLARI (GİZEM ÇÖZÜLDÜ!)
# ==========================================
...
try:
    ...
    # İşte listeden çektiğimiz %100 doğru model ismi!
...
with st.sidebar:
    ...
    st.markdown("<span style='color: #64748B; font-size: 0.9rem;'>Sürüm 6.0 (Stabil)</span>", unsafe_allow_html=True)
    st.divider()
    ...
    with st.chat_message("assistant", avatar="⚖️"):
        with st.spinner("Hukuki analiz yapılıyor..."):
            try:
                ...
                # Kota hatası alırsan (429) bunu kullanıcıya kibarca yansıtıyoruz
                if "429" in str(e):
                    st.warning("⚠️ Çok hızlı soru sordunuz veya ücretsiz kota limitine takıldık. Lütfen 1 dakika bekleyip tekrar deneyin.")
                else:
